  ...
  return (
    <View style={tw`w-full mt-4`}>
      <View style={tw`flex flex-row justify-between items-center py-2`}>
        <Text
          style={[{ fontFamily: "Poppins-Bold" }, tw`text-xl text-neutral-700`]}
        >
          Popular Hotels
        </Text>
        <TouchableOpacity>
          ...
          >
            <>
              ...
              >
                ...
                <Text
                  style={[{ fontFamily: "Poppins-Bold" }, tw`text-white mt-1`]}
                >
                  {item.rating}
                </Text>
              </TouchableOpacity>
              <View style={tw`absolute bottom-4 left-4`}>
                <Text style={[{ fontFamily: "Poppins-Bold" }, tw`text-white `]}>
                  {item.name}
                </Text>
                <View style={tw`flex flex-row items-center gap-2`}>
                  <MapPinIcon size={14} color={"#CCC"} />
                  <Text
                    style={[{ fontFamily: "Poppins-Medium" }, tw`text-[#CCC]`]}
                  >
                    {item.location}
                  </Text>
                </View>
